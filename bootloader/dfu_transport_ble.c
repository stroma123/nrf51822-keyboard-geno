...
#define DEVICE_NAME                          "Dfu_BLE60"                                               /**< Name of device. Will be included in the advertising data. */
#define MANUFACTURER_NAME                    "Genosoft"                                   /**< Manufacturer. Will be passed to Device Information Service. */
...
static void advertising_start(void)
{
    if (!m_is_advertising)
    {
        ...
        LED_SET(ADVERTISING_LED_PIN_NO);
...
static void advertising_stop(void)
{
    if (m_is_advertising)
    {
        ...
        LED_CLEAR(ADVERTISING_LED_PIN_NO);
        ...
        case BLE_GAP_EVT_DISCONNECTED:
            {
                ...
                LED_CLEAR(CONNECTED_LED_PIN_NO);
